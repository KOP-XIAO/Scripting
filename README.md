...
| [video-downloader](./video-downloader/) | 视频下载器：视频号 / m3u8 / 直链下载，平台链接走 cobalt 解析实例，含历史记录与诊断导出（SQLite/转码需 Pro） |
| [video-downloader-lite](./video-downloader-lite/) | 同上 Lite 版：**免费版全功能可用**（历史改 JSON 存储，无 Pro 专属 API） |
...
| video-downloader-lite | `https://raw.githubusercontent.com/KOP-XIAO/Scripting/main/video-downloader-lite.scripting` |
